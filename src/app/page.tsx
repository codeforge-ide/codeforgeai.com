          ...
          <nav className="sticky top-0 bg-black/70 backdrop-blur-xl z-30 border-b border-purple-900/30 shadow-lg rounded-t-2xl">
            <div className="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center">
              <ul className="flex items-center gap-8">
                <li><a href="#home" className="text-white hover:text-purple-400 font-semibold transition-colors duration-200 px-5 py-2 rounded-md hover:bg-purple-900/20">Home</a></li>
                <li><a href="#about" className="text-white hover:text-purple-400 font-semibold transition-colors duration-200 px-5 py-2 rounded-md hover:bg-purple-900/20">About</a></li>
                <li><a href="#showcase" className="text-white hover:text-purple-400 font-semibold transition-colors duration-200 px-5 py-2 rounded-md hover:bg-purple-900/20">Features</a></li>
                <li><a href="#contact" className="text-white hover:text-purple-400 font-semibold transition-colors duration-200 px-5 py-2 rounded-md hover:bg-purple-900/20">Contact</a></li>
              </ul>
              <a href="https://github.com/codeforge-ide/codeforgeai" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-green-400/80 rounded-lg hover:from-purple-500 hover:to-green-300 transition-colors shadow-md border border-purple-700/30">
